...
const ProMondal = () => {
  ...
  return (
    <Dialog open={proModal.isOpen} onOpenChange={proModal.onClose}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="flex justify-between items-center fle-col gap-y-4 pb-2">
          ...
          <DialogDescription className="text-center pt-2 space-y-2 text-zinc-900 font-medium">
            {tools.map((tool)=>(
              <Card key={tool.label} className="p-5 borde-black/5 flex items-center justify-between">
